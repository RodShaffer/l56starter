...
@section('meta')
<meta name="description" content="{{ config('site.title') }} account verification email is invalid.">
@stop

@section('title')
    <title>{{ config('site.title') }} | Account Verification Email Invalid</title>
@stop
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-12">
                            ...
                            <h4 class="cgbg-heading">Account Verification Email Invalid</h4>

                            <p>
                                The account verification email is invalid.
                            </p>
