...
@section('meta')
    @if(isset($role))
        <meta name="description"
              content="{{ config('admin.title') }} Admin index of all users assigned {{ $role->name }} role.">
    @else
        <meta name="description" content="{{ config('admin.title') }} Admin index of all users assigned specific role.">
    @endif
@endsection

@section('title')
    <title>{{ config('admin.title') }} | Admin - All Users Assigned {{ $role->name }} Role</title>
@endsection
        ...
        <div class="row mt-3">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    @if(isset($role))
                        <div class="card-header">Admin - All users assigned "{{ $role->name }}" role</div>
                    @else
                        <div class="card-header">Admin - All users assigned specific role</div>
                    @endif
