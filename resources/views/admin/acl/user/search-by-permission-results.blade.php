...
@section('meta')
    @if(isset($permission))
        <meta name="description"
              content="{{ config('admin.title') }} Admin index of all users assigned {{ $permission->name }} permission.">
    @else
        <meta name="description"
              content="{{ config('admin.title') }} Admin index of all users assigned specific permission.">
    @endif
@endsection

@section('title')
    <title>{{ config('admin.title') }} | Admin - All Users Assigned {{ $permission->name }} Permission</title>
@endsection
        ...
        <div class="row mt-3">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    @if(isset($permission))
                        <div class="card-header">Admin - All users assigned "{{ $permission->name }}" permission</div>
                    @else
                        <div class="card-header">Admin - All users assigned specific permission</div>
                    @endif
...
@section('script')
    @include('admin.acl.user.scripts._search-by-permission-results')
@endsection
