...
@section('meta')
    @if(isset($permission))
        <meta name="description" content="{{ config('admin.title') }} Admin index of all roles assigned {{ $permission->name }} permission.">
    @else
        <meta name="description" content="{{ config('admin.title') }} Admin index of all roles assigned specific permission.">
    @endif
@endsection

@section('title')
    @if(isset($permission))
        <title>{{ config('admin.title') }} | Admin - All Roles Assigned {{ $permission->name }} Permission</title>
    @else
        <title>{{ config('admin.title') }} | Admin - All Roles Assigned Specific Permission</title>
    @endif
@endsection
        ...
        <div class="row mt-3">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    @if(isset($permission))
                        <div class="card-header">Admin - All roles assigned "{{ $permission->name }}" permission</div>
                    @else
                        <div class="card-header">Admin - All roles assigned specific permission</div>
                    @endif
                                                                ...
                                                                @if(count($roles[$i]->users) > 0)
                                                                    ...
                                                                    <p>
                                                                        <a href="{{ route('admin.user.search.role', $roles[$i]) }}">
                                                                            {{ count($roles[$i]->users) }} users assigned to
                                                                            role</a>
                                                                    </p>
                                                                ...
                                                                @if(count($roles[$i]->permissions) > 0)
                                                                    ...
                                                                    <p>
                                                                        <a href="{{ route('admin.permission.search.role', $roles[$i]) }}">
                                                                            {{ count($roles[$i]->permissions) }} permissions
                                                                            assigned to role</a>
                                                                    </p>
